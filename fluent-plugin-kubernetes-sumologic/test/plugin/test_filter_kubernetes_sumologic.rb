...
class SumoContainerOutputTest < Test::Unit::TestCase
  ...
  test "test_fields_pod_annotations" do
    conf = %{
	      log_format fields
	    }
    d = create_driver(conf)
    ...
    expected = {
        ...
        "_sumo_metadata" => {
            ...
            :log_format => "fields",
            :source => "default.log-format-labs-54575ccdb9-9d677.log-format-labs",
            :fields => "container_id=5c280b6ad5abec32e9af729295c20f60fbeadf3ba16fda2d121f87228e6822e0,pod_labels_pod-template-hash=1013177865,pod_labels_run=log-format-labs,pod_annotations_version=1.2.1,container=log-format-labs,namespace=default,pod=log-format-labs-54575ccdb9-9d677,pod_id=170af806-c801-11e8-9009-025000000001,host=docker-for-desktop,master_url=https =>//10.96.0.1 =>443/api,namespace_id=e8572415-9596-11e8-b28b-025000000001,node=docker-for-desktop"
        },
    }
    assert_equal(1, d.filtered_records.size)
    assert_equal(d.filtered_records[0], expected)
